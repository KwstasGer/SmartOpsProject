        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerCode = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false, defaultValueSql: "( 'C' + RIGHT('000000' + CAST(NEXT VALUE FOR dbo.CustomerCodeSeq AS varchar(6)), 6) )"),
                    ...
                    VatStatus = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    CustomerCategory = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ItemCode = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplierCategory = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Customers_UserId_CustomerCode",
                table: "Customers",
                columns: new[] { "UserId", "CustomerCode" },
                unique: true);
